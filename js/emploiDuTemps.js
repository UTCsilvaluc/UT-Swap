...
function changerJour(element){
    ...
    document.getElementById(element.innerHTML.toLowerCase()).classList.add("jour_select");
}
...
var colorList = [
    "#d7ff70", "#a2ff80", "#7aff9e", "#87ffd5", "#8af3ff",
    "#8ac4ff", "#a29cff", "#dc96ff", "#ff85ed", "#ff80bf",
    "#ff7891", "#ff8f75", "#ffbb69", "#ffe669", "#d9fbff"
];
var coursColors = {};
